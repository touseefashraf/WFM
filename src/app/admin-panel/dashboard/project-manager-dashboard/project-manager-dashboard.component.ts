...
export class ProjectManagerDashboardComponent implements OnInit {
    ...
    constructor(
        ...
        this.ds.activeMenu = 'project'
        this.ds.getPMstate().subscribe((resp: any) => {
            if (resp.success === true) {

                this.data = resp.data

                this.absentEmployees = resp.data.absent_employees
                this.inProgressProjects = resp.data.in_progress_projects
                this.closedProjects = resp.data.closed_projects
                this.projectsInSupport = resp.data.projects_in_support
                this.totalProjects = resp.data.total_projects
                this.totalHours = resp.data.total_hours
                this.pendingAttendanceRequests = resp.data.pending_attendance_requests
